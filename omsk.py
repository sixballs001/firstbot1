...
params = {
    "lon": 54.99815961401599,
    "lat": 73.36571888819248,
...
template_city3 = 'Сегодня {}  текущая температура  {}. Ощущается как {}  в городе {}.Скорость ветра {} м/с'.format(today,gradus(s),data["main"]["feels_like"], city[3], data["wind"]["speed"])
