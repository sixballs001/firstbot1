...
params = {
    "lon": 71.18525900985524,
    "lat": 66.89647354104311,
...
template_city1 = 'Сегодня {}  текущая температура  {}. Ощущается как {}  в городе {}.Скорость ветра {} м/с'.format(today,gradus(s),data["main"]["feels_like"], city[1], data["wind"]["speed"])
