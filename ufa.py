...
params = {
    "lon": 54.74250738106591,
    "lat": 55.98565030232395,
...
template_city4 = 'Сегодня {}  текущая температура  {}. Ощущается как {}  в городе {}.Скорость ветра {} м/с'.format(today,gradus(s),data["main"]["feels_like"], city[4], data["wind"]["speed"])
